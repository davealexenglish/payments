...
interface MaxioConnectionDialogProps {
...
export function MaxioConnectionDialog({
  connectionId,
  existingData,
  onClose,
  onSuccess
}: MaxioConnectionDialogProps) {
  const isEditMode = !!connectionId

  const [name, setName] = useState(existingData?.name || '')
  const [subdomain, setSubdomain] = useState(existingData?.subdomain || '')
    ...
    <div className="modal-overlay">
      <div className="modal-dialog">
        <div className="modal-header">
          {isEditMode ? 'Edit' : 'Add'} Maxio Connection
